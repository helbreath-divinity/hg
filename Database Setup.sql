...
-- Dumping database structure for server_db
CREATE DATABASE IF NOT EXISTS `server_db` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `server_db`;


-- Dumping structure for table server_db.account_database
...
-- Dumping structure for table server_db.cash_transactions
...
-- Dumping structure for table server_db.char_database
CREATE TABLE IF NOT EXISTS `char_database` (
  ...
  `Dexterity` tinyint(4) unsigned zerofill NOT NULL DEFAULT '0010',
...
-- Dumping structure for table server_db.guild
...
-- Dumping structure for table server_db.guild_member
...
-- Dumping structure for table server_db.ipblocked
...
-- Dumping structure for table server_db.item
...
-- Dumping structure for table server_db.macblocked
...
-- Dumping structure for table server_db.mail
...
-- Dumping structure for table server_db.paypal_cart_info
...
-- Dumping structure for table server_db.paypal_payment_info
...
-- Dumping structure for table server_db.paypal_subscription_info
...
-- Dumping structure for table server_db.skill
...
-- Dumping structure for table server_db.stats
