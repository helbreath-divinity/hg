...
CDynamicObject::CDynamicObject(short sOwner, char cOwnerType, short sType, char cMapIndex, short sX, short sY, uint32 dwRegisterTime, uint32 dwLastTime, int iV1)
{
	m_sOwner         = sOwner;
