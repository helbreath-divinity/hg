...
//=============================================================================
void CALLBACK _TimerFunc(UINT wID, UINT wUser, uint32 dwUSer, uint32 dw1, uint32 dw2)
{
...
//=============================================================================
BYTE bGetOffsetValue(char * cp, uint32 offset)
{
 char   *pcp;
 BYTE	*bp;
...
//=============================================================================
uint16 wGetOffsetValue(char * cp, uint32 offset)
{
 char   *pcp;
 uint16	*wp;
...
//=============================================================================
uint32 dwGetOffsetValue(char * cp, uint32 offset)
{
	char   *pcp;
	uint32	*dwp;
...
uint64 ullGetOffsetValue(char * cp, uint32 offset)
{
	char   *pcp;
	uint64	*dwp;
...
//=============================================================================
void PutOffsetValue(char * cp, uint32 offset, BYTE size, uint64 value)
{
	BYTE   *bp;
	uint16   *wp;
	uint32  *dwp;
...
//=============================================================================
void SafeCopy(char *c1, char *c2, uint32 lenght)
{
 uint32 dw;
...
void parseCommand(char* pMsg)
{
	...
	*/
		...
		while(CGuild * guild = guildMgr.Get())
		{
