...
public:
	...
	int  ProcessQuery(MYSQL *myConn, const char *cQuery);
	...
	void RequestGuildBoard(char * data, WORD GSID, MYSQL myConn);
	void RequestGuildBoardPost(char * data, WORD GSID, MYSQL myConn);
	void RequestDeleteGuildBoardPost(char * data, WORD GSID, MYSQL myConn);
	void RequestPostGuildBoard(char * data, WORD GSID, MYSQL myConn);

	void RequestMailbox(char * data, WORD GSID, MYSQL myConn);
	void RequestMailData(char * data, WORD GSID, MYSQL myConn);
	void RequestRetrieveMailItem(char * data, WORD GSID, MYSQL myConn);
	void RequestDeleteMail(char * data, WORD GSID, MYSQL myConn);
	void RequestSendMail(char * data, WORD GSID, MYSQL myConn);
	...
	DWORD           KeyDownTimer, mySQLTimer, mySQLdbRepairTimer, mySQLdbOptimizeTimer;
	DWORD updateStatsTimer, updateOnlineTimer;
